...
By The Milk Man (@MrMilkTrading), crediting Linda Raschke (@LindaRaschke) for the original rule.

Mentioned by The Milk Man in `this discussion <https://x.com/MrMilkTrading/status/2094768621419471130>`__, where he presents it as "the Legend's EMA strategy" and asks readers to improve on it. A follow-up thread exists but could not be retrieved for this entry; the exact entry, exit and trend-day definitions are likely to be found there.

`Read the post <https://x.com/MrMilkTrading/status/2094768621419471130>`__.
