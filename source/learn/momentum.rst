...
A System Behind a +40% Week — Six Years of Trading Experience Compressed Into One Article
-------------------------------------------------------------------------------------------

An X Article by Michael (@MichaelZTrading), an English rendering of an April 2026 piece credited to @kovainvest, that writes out a complete discretionary momentum-breakout process in the William O'Neil / Mark Minervini / Stan Weinstein lineage — stock selection, screening, entry, stop-loss, pyramiding, selling, exposure control and journaling — as a single non-negotiable checklist. The framing device is a letter to the author's earlier self, who lost 40% in two months despite having read the books; the argument is that the missing piece was never theory but a process that removes in-the-moment discretion. The "+40% week" of the title is the account's return in the week before publication, shown as an X portfolio-performance card at the top of the article; no track record beyond that single figure is given.

**The process.** Stock selection is a four-gate filter, all gates mandatory: fundamentals (quarterly EPS growth of 25%+ year-over-year, ideally accelerating, and revenue growth of 20%+ — the C and A of CAN SLIM), technicals (RS Rating 80+ and preferably 90+, price above the 50-day moving average, 10-day above 20-day, within 15–20% of the 52-week high), institutional sponsorship (a rising count of fund holders in 13F filings), and market environment (a confirmed index uptrend with no cluster of distribution days, on the O'Neil premise that three-quarters of stocks move with the market). The weekly screener is disclosed verbatim — price above $10, average daily range above 4%, RS above 90, price above the 50 EMA, 10 EMA above 20 EMA, more than 70% above the 52-week low — and typically returns 50–80 names, which three rounds of chart review cut to a 10–15 name watchlist by discarding "ugly" charts, flagging cup-with-handle, flat and VCP bases, and keeping names where the 10/20 EMA cross or the base contraction is about to complete. The author says the screener has been backtested "hundreds of times on QuantConnect" but reports no statistics from it.

**Entry, stop and sizing rules.** The primary setup is Minervini's Volatility Contraction Pattern, defined strictly as three simultaneous contractions: successive pullbacks shrinking from 25–35% to 15–20% to 5–10%, volume falling well below the 50-day average with several near-dead sessions, and 3–5 consecutive days of sub-1% closes. The trigger is the consolidation high plus 10 cents on a day whose volume is 40–50% above the 50-day average; the buy zone runs from the pivot to 5% above it, beyond which the trade is passed. The preferred entry, though, is the pocket pivot — an up day whose volume exceeds the largest down-day volume of the prior ten sessions — taken late in the contraction and timed on a 60- or 15-minute chart, which the author says accounts for all of his most profitable trades and, in the $RKLB example, got him in roughly 8% below the daily-chart breakout. Stops are a 7–8% hard ceiling with the actual stop the tightest of: just below the pivot, 2–3% under the entry-day low, below the 21 EMA, or 2× ATR; a time stop exits anything going nowhere after 2–3 weeks; and a low-volume intraday pierce that closes back above the pivot is a shakeout to be re-bought, whereas a heavy-volume close below is a failure. Adds are pyramided 50/30/20 at the breakout, +2–3% and +2–5% (or the next pocket pivot), never into a loser, never more than 5% above the pivot and never when the index is weakening, with a 25% cap per name and 3–5 names in total.

**Exits and exposure.** Offensive selling uses O'Neil's 8-week rule (a 20% gain within three weeks of breakout is held at least eight weeks), climax-run diagnostics (25–30%+ in 2–3 weeks, widening ranges, gap-ups on heavy volume, price escaping the trend channel — illustrated with $MU and $SNDK, where he trimmed half and trailed the rest against the 10 EMA), and churning (heavy volume with no progress or weak closes). Defensive selling triggers on a heavy-volume break of the 50-day / 10-week average, a broken uptrend line, five or more distribution days in 4–5 weeks, or a post-earnings gap below the 50 EMA, with the instruction to place the order the moment the signal fires. Portfolio exposure is regime-gated: above the 50 EMA with no distribution cluster, up to 4–5 positions; below it with 5+ distribution days in four weeks, total exposure under 30% in the one or two strongest names. Three consecutive stop-outs halve position size; five stop the trader for a week. The piece closes with a trading-journal template and the claim that the rules take an hour to understand and three years to execute.

**Our reading.** This is a well-organised statement of the growth-stock breakout canon rather than new evidence, and its value is as a fully specified checklist that can be turned into testable hypotheses. Every number is asserted rather than measured: the "decades of CAN SLIM history" behind the 7–8% stop, the 40–50% volume threshold, the 75% index co-movement figure and the 8-week rule are all inherited from O'Neil and Minervini, and none comes with a hit rate, expectancy, drawdown or sample. The two trade examples and the headline week are anecdotes selected after the fact, and the QuantConnect backtests are mentioned without a single result. The process is also less systematic than its presentation suggests: the screener is mechanical, but the three chart-review passes ("ugly shape", "clean base", "about to complete its contraction"), the multi-timeframe pocket-pivot timing and the climax-run judgement are where selection actually happens, and they are not reducible to rules — the checklist disciplines a discretionary trader rather than replacing one. There are internal tensions worth noticing: a fixed 7–8% stop on a universe filtered for an average daily range above 4% is one-and-a-half to two days of ordinary noise, which the "take the tightest stop" rule makes worse, and the shakeout re-entry clause is a standing invitation to be whipsawed twice. The regime rules, the losing-streak circuit breaker, the time stop and the insistence on doing nothing in signal-less weeks are the parts most likely to survive a serious test.

**Related concepts.** Each gate in the selection filter maps onto a documented effect. An RS Rating above 80 with price within 15–20% of the 52-week high is cross-sectional momentum plus the 52-week-high anchor, both of which Baltussen et al. show to be robust across 159 years and 46 countries in "Momentum Factor Investing: Evidence and Evolution" (above), and their finding that momentum is also present in earnings surprises and analyst revisions is the academic counterpart of the EPS-acceleration gate. The "M" gate — trading breakouts only in a confirmed index uptrend and cutting exposure when distribution days pile up — is a hand-rolled version of the regime conditioning in Goulding, Harvey and Mazzoleni's :doc:`Momentum Turning Points and Breaking Bad Trends <./trend-following>`, where Correction and Rebound states are exactly the periods in which trend entries perform worst, and of the timing work in "Systematic Regime Detection for Momentum Strategy Timing" (above). The VCP's three-way contraction followed by a volume-confirmed range expansion has a direct quantitative analogue in :doc:`100 Trading Indicators Tested Across 4,100+ Strategies <./technical-indicators>`, where bar range relative to ATR and volume were the only filters that consistently improved thousands of breakout systems out of sample while oscillators consistently hurt them; the continuation edge after a break of a significant high is what :doc:`Do Breakouts of Strong Swings Work? <./trend-following>` measures across 40 futures markets. The pocket-pivot logic — buying late-contraction days inside an established uptrend rather than the visible breakout — sits between the breakout school and the pullback entries in "Corrections Within Momentum" and "Simple Crypto Momentum Strategy: Buying Corrections" (both above), and the observation that waiting for the daily candle costs 8% of entry price is the same trade-off those entries exploit.

**Validation elsewhere.** The exit and sizing rules are where the collection's evidence pushes back hardest. Fixed-percentage stops are examined in :doc:`The Hidden Costs and Return Erosion of Stop Losses in Systematic Trading <./risk-management>`, which quantifies how much return stops give up for the risk they remove, and volatility-scaled alternatives are argued for in :doc:`Vol-Based Stops <./risk-management>` and :doc:`Why Volatility-Adjusted Sizing Matters More Than You Think <./risk-management>` — the article's 2× ATR stop is the right instinct, but taking the tightest of four stops throws it away. The entry-day-low and time-stop rules, by contrast, are the kind of practitioner rule that :doc:`Testing the Low-of-Day Stop Loss Rule in Crypto Trend-Following <./trend-following>` subjects to a backtest, and the :doc:`Bilbo Box Breakout <./backtesting>` write-up, whose 21 EMA gate, volume gate and 10-day time stop are nearly the same rules on a different instrument, found that every premium-based stop and profit target it tried made results worse. The 50/30/20 pyramid is directly contradicted by :doc:`Pyramiding Behaves Very Differently Across Trading Models <./risk-management>`, whose argument is that adding into a breakout raises the cost basis precisely when the remaining move is shortest and the payoff depends most on a rare outlier; the article's own "never add more than 5% above the pivot" clause is a tacit concession. The elevated crash risk of concentrated momentum books documented in "Factor Performance 2010-2019: A Lost Decade?" (above) is the reason the exposure-cutting rules matter more than the entry rules, and :doc:`Why Published Trading Edges Still Work Decades Later <./backtesting>` supplies the argument for why a process published by O'Neil in 1988 can still carry an edge — the behavioural cost of holding through a 30% base pullback and of sitting in cash for weeks is one most participants will not pay. For a systematic counterpart to this discretionary process, "US Stock Momentum Trading System for Retail Traders" (above) covers the same universe-selection, ranking and rebalancing questions with rules that can actually be backtested.

Published by Michael (@MichaelZTrading) as an X Article on September 17, 2026, crediting @kovainvest as the original author (dated April 17, 2026); it had drawn roughly 360K views within a day.

By @kovainvest, English edition by Michael (@MichaelZTrading).

`Read the article <https://x.com/MichaelZTrading/article/2100596335162380479>`__.
